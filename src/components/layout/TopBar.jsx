    ...
    <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white overflow-x-hidden">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-6 px-4 md:px-8 py-2 text-xs md:text-sm">
        <a
          ...
          className="flex items-center gap-2 text-slate-400 min-h-[44px] sm:min-h-auto focus:outline-none focus:ring-2 focus:ring-cyan-500 rounded"
          aria-label="Call us"
        >
        ...
        <a
          ...
          className="flex items-center gap-2 text-slate-400 min-h-[44px] sm:min-h-auto focus:outline-none focus:ring-2 focus:ring-cyan-500 rounded truncate"
          aria-label="Email us"
        >
          <i className="fas fa-envelope text-cyan-500 flex-shrink-0"></i>
